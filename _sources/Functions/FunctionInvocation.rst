...
referred to by the variable hello. Its type is officially 'function'.
...
.. mchoice:: question11_2_3
   ...
   :feedback_c: When the function is invoked, it will print two lines, but here it has only been defined, not invoked.
   :practice: T
