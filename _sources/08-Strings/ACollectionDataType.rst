...
are made up of smaller pieces: individual characters.  

Types that are comprised of smaller pieces are called **collection types**.
Depending on what we are doing, we may want to treat a collection type as a
single entity (the whole), or we may want to access its parts. This flexibility is useful.
