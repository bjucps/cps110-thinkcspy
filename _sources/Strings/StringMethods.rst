...
.. mchoice:: test_question8_3_5
   :practice: T
   :answer_a: PYTHON ROCKS
   :answer_b: python rocks
   :correct: b
   :feedback_a: No. s.upper() produces a temporary uppercase version of s (which is discarded unused in this example), but does not change s itself.
   :feedback_b: Correct. s.upper() produces an uppercase version of s, but does not change s itself.
